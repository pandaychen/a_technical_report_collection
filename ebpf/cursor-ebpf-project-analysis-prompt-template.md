...
## Claude Code / Cursor Skill 集成

本模板已同步为可安装的 **Skill**（`SKILL.md` + `reference-phases.md`）：

| 工具 | 项目内路径 | 全局路径（复制整目录） |
|------|------------|------------------------|
| **Claude Code** | `.claude/skills/ebpf-project-analysis/` | `~/.claude/skills/ebpf-project-analysis/` |
| **Cursor** | `.cursor/skills/ebpf-project-analysis/` | `~/.cursor/skills/ebpf-project-analysis/` |

安装步骤与重启说明见：`.claude/skills/ebpf-project-analysis/README.md`。
